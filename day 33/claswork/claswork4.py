...
# 5. Use the reverse() function to reverse the order of the list.





# 6. Use the index() function to find the index of the number 50.



# 7. Use the count() function to count how many times 20 appears in the list.